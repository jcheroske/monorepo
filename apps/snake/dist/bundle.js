...
var bundle = (function () {
    ...
    /* Users/jay/WebstormProjects/lerna-monorepo/dev-lib/tailwind-svelte/Component.svelte generated by Svelte v3.29.7 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(/*$timer*/ ctx[0]);
    			attr_dev(h1, "class", "text-white bg-black");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$timer*/ 1) set_data_dev(t, /*$timer*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ timer, $timer });
    	return [$timer];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	let timer;
    	let current;
    	tailwind = new Component({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 5, 2, 126);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tailwind: Component, Timer });
    	return [];
    }
